...
export async function uploadVideoSpeechImage(webFormData) {
...
export async function deleteVideoSpeechImage(imagePath) {
  const token = await getToken();
  await authApiClient.delete("VideoSpeeches/delete-image", {
