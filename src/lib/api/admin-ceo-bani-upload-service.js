...
export async function uploadCeoBaniImage(webFormData, lang) {
...
export async function deleteCeoBaniImage(imagePath) {
  const token = await getToken();
  await authApiClient.delete("CeoBani/delete-image", {
