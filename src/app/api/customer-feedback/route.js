...
function extractMessage(error) {
  ...
  return error?.message ?? "Unable to submit feedback right now.";
}
...
export async function GET() {
  try {
    ...
    return NextResponse.json({ message: extractMessage(error) }, { status: extractStatus(error) });
  }
}
