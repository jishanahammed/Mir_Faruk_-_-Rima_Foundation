...
function Pagination({ pageNumber, totalPages, pageSize, search }) {
  function href(p) {
    ...
    return `/admin/project-category?${sp.toString()}`;
  }
...
export function ProjectCategoryTable({ data, search, updateStatusAction, deleteAction }) {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-3 border-b border-slate-100 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
        <form method="get" action="/admin/project-category" className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          ...
          <form method="get" action="/admin/project-category">
                ...
                <tr key={cat.id} className="group transition hover:bg-cyan-50/40">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-2">
                      <Link
                        href={`/admin/project-category?edit=${cat.id}`}
