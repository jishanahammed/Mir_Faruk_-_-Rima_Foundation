...
const donorFormCopy = {
  ...
  bn: {
    ...
    alreadyRegisteredTitle: "আপনি ইতিমধ্যে নিবন্ধিত",
    alreadyRegisteredText:
      "এই ইমেইল বা মোবাইল নম্বর দিয়ে একটি অ্যাকাউন্ট ইতিমধ্যে আছে। অনুগ্রহ করে লগইন করুন।",
  ...
  da: {
    ...
    alreadyRegisteredTitle: "Du er allerede registreret",
    alreadyRegisteredText:
      "Der findes allerede en konto med denne e-mail eller dette mobilnummer. Log venligst ind i stedet.",
    goToLoginLabel: "Gaa til login",
...
export function DonorRegistrationForm() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (error?.status === 409 || /already\s+(exists|registered)/i.test(message)) {
