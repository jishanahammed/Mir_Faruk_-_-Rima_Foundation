...
const modalCopy = {
  en: {
    ...
    transaction: {
      ...
      attachment: "Transaction Screenshot",
      attachmentHint: "Drag an image here or click to browse · up to 5 MB",
      attachmentChoose: "Add a screenshot",
      attachmentAttached: "Attached",
      attachmentUploading: "Uploading…",
      attachmentRemove: "Remove",
      attachmentError: "Could not upload the image. Please try again.",
      attachmentTypeError: "Only image files can be attached.",
      attachmentSizeError: "The image must be 5 MB or smaller.",
      submit: "Send Details",
      sending: "Sending…",
  ...
  bn: {
    ...
    transaction: {
      ...
      attachment: "লেনদেনের স্ক্রিনশট",
      attachmentHint: "ছবি এখানে টেনে আনুন অথবা ক্লিক করুন · সর্বোচ্চ ৫ এমবি",
      attachmentChoose: "স্ক্রিনশট যোগ করুন",
      attachmentAttached: "সংযুক্ত হয়েছে",
      attachmentUploading: "আপলোড হচ্ছে…",
      attachmentRemove: "সরান",
      attachmentError: "ছবিটি আপলোড করা যায়নি। আবার চেষ্টা করুন।",
      attachmentTypeError: "শুধুমাত্র ছবি সংযুক্ত করা যাবে।",
      attachmentSizeError: "ছবিটি ৫ এমবি বা তার কম হতে হবে।",
      submit: "বিবরণ পাঠান",
  ...
  da: {
    ...
    transaction: {
      ...
      attachment: "Skaermbillede af transaktionen",
      attachmentHint: "Traek et billede hertil eller klik · op til 5 MB",
      attachmentChoose: "Tilfoej et skaermbillede",
      attachmentAttached: "Vedhaeftet",
      attachmentUploading: "Uploader…",
      attachmentRemove: "Fjern",
      attachmentError: "Billedet kunne ikke uploades. Proev igen.",
      attachmentTypeError: "Kun billedfiler kan vedhaeftes.",
      attachmentSizeError: "Billedet skal vaere 5 MB eller mindre.",
